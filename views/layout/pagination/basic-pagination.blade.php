    ...
    <nav aria-label="navigation">
        <ul class="pagination c-pagination">
                ...
                <li class="page-item">
                    <a class="page-link" href="{{ $first }}">
                        <svg style="height: 1.3em; padding-top: .25em; padding-bottom: .25em"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="fast-backward"
                            class="svg-inline--fa fa-fast-backward fa-w-16" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path fill="currentColor"
                                d="M0 436V76c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v151.9L235.5 71.4C256.1 54.3 288 68.6 288 96v131.9L459.5 71.4C480.1 54.3 512 68.6 512 96v320c0 27.4-31.9 41.7-52.5 24.6L288 285.3V416c0 27.4-31.9 41.7-52.5 24.6L64 285.3V436c0 6.6-5.4 12-12 12H12c-6.6 0-12-5.4-12-12z"></path>
                        </svg>
            ...
            @if ($previous = $result->getPrevious())
                <li class="page-item">
                    <a class="page-link" href="{{ $previous }}">
                        <svg style="height: 1.3em; padding-top: .25em; padding-bottom: .25em"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="backward"
                            class="svg-inline--fa fa-backward fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path fill="currentColor"
            ...
            @foreach ($result->getPages() as $k => $page)
                ...
                $distanceClass = abs($page->page - $current->page) > $mobileNeighbours ? 'd-none d-md-block' : '';
                ?>
                <li class="page-item {{ $active ? 'active' : $distanceClass }}">
            ...
            @if ($next = $result->getNext())
                <li class="page-item">
                    <a class="page-link" href="{{ $next }}">
                        ...
                        <svg style="height: 1.3em; padding-top: .25em; padding-bottom: .25em"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="forward"
            ...
            @if ($last = $result->getLast())
                <li class="page-item">
                    <a class="page-link" href="{{ $last }}">
                        ...
                        <svg style="height: 1.3em; padding-top: .25em; padding-bottom: .25em"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="fast-forward"
                            class="svg-inline--fa fa-fast-forward fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path fill="currentColor"
                                d="M512 76v360c0 6.6-5.4 12-12 12h-40c-6.6 0-12-5.4-12-12V284.1L276.5 440.6c-20.6 17.2-52.5 2.8-52.5-24.6V284.1L52.5 440.6C31.9 457.8 0 443.4 0 416V96c0-27.4 31.9-41.7 52.5-24.6L224 226.8V96c0-27.4 31.9-41.7 52.5-24.6L448 226.8V76c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12z"></path>
                        </svg>
                    </a>
                </li>
            @endif

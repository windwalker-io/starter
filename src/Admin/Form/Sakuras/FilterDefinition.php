...
/**
 * The SakurasFilterDefinition class.
 *
 * @since  1.0
 */
	...
	public function define(Form $form)
	{
		...
		$form->wrap(null, 'search', function (Form $form)
		{
			...
			$form->add('field', new ListField)
				...
				->addOption(new Option(Translator::translate('admin.sakura.field.title'), 'sakura.title'))
				->addOption(new Option(Translator::translate('admin.sakura.field.alias'), 'sakura.alias'));
		...
		{
			// State
			$form->add('sakura.state', new ListField)
				->label('State')
				// Add empty option to support single deselect button
				->addOption(new Option('', ''))
				->addOption(new Option(Translator::translate('admin.sakura.filter.state.select'), ''))

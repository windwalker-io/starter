...
define('WINDWALKER_CACHE', env('CACHE_PATH') ?? WINDWALKER_ROOT . DIRECTORY_SEPARATOR . 'cache');
define('WINDWALKER_TEMP', env('TEMP_PATH') ?? WINDWALKER_ROOT . DIRECTORY_SEPARATOR . 'tmp');

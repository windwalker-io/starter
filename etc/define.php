...
define('WINDWALKER_BIN',       WINDWALKER_ROOT . '/bin');
define('WINDWALKER_CACHE',     WINDWALKER_ROOT . '/cache');
...
define('WINDWALKER_MIGRATIONS', WINDWALKER_RESOURCES . '/migrations');
define('WINDWALKER_SEEDERS',    WINDWALKER_RESOURCES . '/seeders');
define('WINDWALKER_LANGUAGES',  WINDWALKER_RESOURCES . '/languages');

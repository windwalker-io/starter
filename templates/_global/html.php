...
<div class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo $data->route->encode('home'); ?>">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<?php $this->block('nav'); ?>
				<li class="active"><a href="<?php echo $data->route->encode('home'); ?>">Home</a></li>
				<?php $this->endblock(); ?>
			</ul>
...
<?php $this->block('message') ?>
	<div id="messasge" class="container">
		<?php echo $data->widget->render('windwalker.message.default', array('messages' => $data->messages)); ?>
	</div>
<?php $this->endblock(); ?>
